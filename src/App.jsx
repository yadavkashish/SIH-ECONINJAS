...
import BuyBulk from "./pages/BuyBulk";
      ...
      <ProgressProvider>
        ...
        <main className="ml-64 flex-1 p-6 bg-gray-50 min-h-screen">
          <Routes>
            ...
            <Route path="/buy/bulk" element={<BuyBulk />} />
            <Route path="/buy" element={<BuyDashboard />} />
            
            <Route path="/sell" element={<SellDashboard/>} />
           
           <Route path="/sell/finished" element={<SellForm category="Finished Items" />} />
           <Route path="/sell/bulk" element={<SellForm category="Bulk Waste" />} />
           <Route path="/sell/finished" element={<SellForm category="Finished Items" />} />
